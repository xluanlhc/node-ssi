...
module.exports = (function() {
	...
	DirectiveHandler.prototype = {
		...
		_handleInclude: function(attributes, currentFile, variables) {
			...
			var resolvedInclPath = this.ioUtils.resolveFullPath(currentFile, filename, attributeName);
			var results = {output: fs.readFileSync(resolvedInclPath, {encoding: "utf8"})};

			// Parse the contents of the file to handle SSI directives
			var parsed = this.parser.parse(resolvedInclPath, results.output, variables);
